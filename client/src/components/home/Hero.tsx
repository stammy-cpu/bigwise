  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="relative z-10 h-full container mx-auto px-6 md:px-8 lg:px-12 flex flex-col justify-center items-start pt-20">
        ...
        >
          <h2 className="text-xs sm:text-sm md:text-base font-bold tracking-[0.2em] uppercase mb-3 sm:mb-4 text-purple-300">
            Est. 2020 • Ile-Ife & Lagos
          </h2>
          <h1 className="text-3xl sm:text-4xl md:text-7xl lg:text-8xl font-heading font-extrabold leading-tight mb-4 sm:mb-6">
            Fashion for the <br/>
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400">Bold & Wise</span>
          </h1>
          <p className="text-sm sm:text-base md:text-xl text-gray-200 mb-6 sm:mb-10 max-w-lg leading-relaxed font-light">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4">
            <Link href="/collections" className="w-full sm:w-auto">
              <Button 
                size="lg" 
                className="w-full sm:w-auto bg-purple-600 hover:bg-purple-700 text-white rounded-full h-12 sm:h-14 px-6 sm:px-10 text-xs sm:text-sm uppercase tracking-widest font-bold transition-all shadow-lg shadow-purple-600/30 hover:scale-105"
              >
                Shop Collection
              </Button>
            </Link>
            <Link href="/collections?category=new" className="w-full sm:w-auto">
              <Button 
                variant="outline" 
                size="lg" 
                className="w-full sm:w-auto border-white/30 text-white hover:bg-white/10 hover:border-white rounded-full h-12 sm:h-14 px-6 sm:px-10 text-xs sm:text-sm uppercase tracking-widest font-bold bg-transparent backdrop-blur-sm"
              >
                New Arrivals
              </Button>
            </Link>
