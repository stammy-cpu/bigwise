    ...
    >
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-12">
        <div className="flex items-center justify-between min-h-16 sm:min-h-20">
          ...
          <Link 
            href="/"
            className="text-lg sm:text-2xl md:text-3xl font-heading font-extrabold tracking-tighter text-center absolute left-1/2 -translate-x-1/2 md:static md:transform-none bg-clip-text text-transparent bg-gradient-to-r from-purple-200 to-white"
          ...
          <div className="flex md:hidden gap-4 text-white">
             <Link href="/cart">
              <ShoppingBag className="w-5 h-5 cursor-pointer hover:text-purple-300 transition-colors" />
             </Link>
          </div>
        </div>
