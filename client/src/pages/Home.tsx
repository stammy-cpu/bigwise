...
import menImg from "@assets/generated_images/black_male_model_dreadlocks_fashion.png";
import womenImg from "@assets/generated_images/black_female_model_elegant_dress_fashion.png";

// Placeholder for Trending Items
const trendingItems = [
  { id: 1, name: "Urban Bomber", price: "₦35,000", image: trendingImg1, stock: "in" },
  { id: 2, name: "Velvet Dress", price: "₦50,000", image: trendingImg2, stock: "out" },
  { id: 3, name: "Street Hoodie", price: "₦27,000", image: trendingImg3, stock: "in" },
  { id: 4, name: "Classic Tee", price: "₦14,500", image: trendingImg4, stock: "out" },
];
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#1a1025] text-white font-sans">
      ...
      <main className="flex-grow">
        ...
        <section className="py-12 md:py-24 bg-[#1a1025] px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
              ...
              <motion.div
                ...
                className="group cursor-pointer relative overflow-hidden rounded-lg sm:rounded-xl"
              >
                <Link href="/collections" className="block">
                  <div className="relative aspect-[3/4] sm:aspect-[9/16] overflow-hidden rounded-lg sm:rounded-xl bg-gray-900">
                    <img 
                      src={menImg} 
                      alt="Men Collection" 
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8">
                      <h3 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-white mb-2 sm:mb-3">Men</h3>
                      <Button className="bg-white text-black hover:bg-gray-200 font-bold px-4 sm:px-6 py-2 rounded-full text-sm">
                        Shop Men
                      </Button>
                    </div>
                  </div>
              ...
              >
                <Link href="/collections" className="block">
                  <div className="relative aspect-[3/4] sm:aspect-[9/16] overflow-hidden rounded-lg sm:rounded-xl bg-gray-900">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent" />
                    <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 md:p-8">
                      <h3 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold text-white mb-2 sm:mb-3">Women</h3>
                      <Button className="bg-white text-black hover:bg-gray-200 font-bold px-4 sm:px-6 py-2 rounded-full text-sm">
                        Shop Women
                      </Button>
                    </div>
        ...
        {/* Trending Section */}
        <section className="py-12 md:py-24 bg-gradient-to-b from-[#1a1025] to-[#251b35] px-4 sm:px-6 md:px-8 lg:px-12">
          <div className="container mx-auto">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-8 sm:mb-12 gap-3 sm:gap-4">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-heading font-bold">Trending Now</h2>
              <Link href="/collections" className="hidden sm:flex text-purple-400 hover:text-purple-300 items-center gap-2 text-xs sm:text-sm uppercase tracking-wider font-bold">
                  ...
                  <Link href={`/product/${item.id}`} className="block">
                      <div className="aspect-[3/4] rounded-lg mb-4 overflow-hidden relative bg-gray-800 border border-white/10 group-hover:border-purple-500/50 transition-all">
                        ...
                        <div className="absolute top-3 right-3">
                          <span className={`text-xs font-bold px-3 py-1 rounded-full uppercase tracking-widest ${item.stock === "in" ? "bg-green-500/20 text-green-300 border border-green-400/50" : "bg-red-500/20 text-red-300 border border-red-400/50"}`}>
